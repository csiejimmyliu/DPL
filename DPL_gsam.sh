...
CUDA_VISIBLE_DEVICES=0 python BG_estimate_gsam.py \
    --input_image ${IMG_FOLDER}/${FILE_NAME}.${IMG_FORMAT} \
    --results_folder output_gsam/ \
    #--use_float_16 \
...
CUDA_VISIBLE_DEVICES=0 python DPL_gsam.py \
    --input_image ${IMG_FOLDER}/${FILE_NAME}.${IMG_FORMAT} \
    --results_folder output_gsam/${FILE_NAME}/ \
    ...
    --smooth_op \
    --softmax_op \
    --seg_dirs output_gsam/${FILE_NAME}/sd_study/ \
    #--use_float_16 \